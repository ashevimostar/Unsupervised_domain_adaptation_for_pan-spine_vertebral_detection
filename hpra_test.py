...
def parse_option():
    ...
    # parser.add_argument('--desc', type=str, default="isic_supcon_co_1")
    # parser.add_argument('--desc', type=str, default="isic_simclr_co_1_plus_1")
    # parser.add_argument('--desc', type=str, default="isic_co_5_plus_6_bksize_30")
    # parser.add_argument('--desc', type=str, default="aptos_adco_2_plus_2")
    # parser.add_argument('--desc', type=str, default="isic_co_5_plus_7_bksize_2")
    # parser.add_argument('--desc', type=str, default="isic_co_5_plus_8_alpha05_1")
    # parser.add_argument('--desc', type=str, default="isic_co_5_plus_9_beta05_1")
    parser.add_argument('--desc', type=str, default="tttttttttttttttttt")
    ...
    parser.add_argument('--ng_queL', type=int, default=100)
    parser.add_argument('--po_queL', type=int, default=20)
    parser.add_argument('--wd', type=float, default=1e-4)
    parser.add_argument('--memo_lr', type=float, default=3) # 3e-1
    parser.add_argument('--mini_bank_size', type=int, default=7) # 7
    parser.add_argument('--rand_vec', type=float, default=0.15) # 0.1
    ...
    # to_test
    # opt.ckpt = '/home/xunxun/workspace/lnco/save/SupCon/path_models/isic_co_5_plus_2_SupCon_path_resnet50_lr_0.0001_decay_0.0001_bsz_64_temp_0.07_trial_0_memolr_0.3_cosine/ckpt_epoch_175.pth'
